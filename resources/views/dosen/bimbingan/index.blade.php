...
.mhs-nim{font-size:0.78rem;color:#6B7280;margin:0;}
.feedback-preview{font-size:0.8rem;color:#6B7280;margin-top:0.75rem;padding-top:0.75rem;border-top:1px solid #F3F4F6;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}
    ...
    <div class="mhs-card">
        <div style="display:flex;align-items:center;gap:0.875rem;">
            ...
            <div>
                ...
                <p class="mhs-nim">{{ $item->NIM ?? 'NIM belum diisi' }}</p>
            </div>
        </div>
        <div class="feedback-preview">
            <strong>Feedback terakhir:</strong> {{ $arrFeedback[$item->mhs_id] ?? 'Belum ada bimbingan' }}
        </div>
        <a href="{{ route('dospem.bimbingan', $item->mhs_id) }}" class="btn-review">Lihat Bimbingan</a>
    </div>
    @endforeach
</div>
@endif
