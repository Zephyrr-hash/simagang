...
<div class="profile-card">
    <div class="profile-header">
        @if($profile?->foto_dosen && file_exists(public_path('images/'.$profile->foto_dosen)))
            <img src="{{ asset('images/'.$profile->foto_dosen) }}" alt="Foto" class="profile-avatar">
        @else
    ...
    <div class="profile-body">
        <div class="info-row"><span class="info-label">Nama</span><span class="info-value">{{ $profile?->nama_dosen ?? '—' }}</span></div>
        <div class="info-row"><span class="info-label">NIP</span><span class="info-value">{{ $profile?->NIP ?? '—' }}</span></div>
        <div class="info-row"><span class="info-label">Telepon</span><span class="info-value">{{ $profile?->telepon_dosen ?? '—' }}</span></div>
