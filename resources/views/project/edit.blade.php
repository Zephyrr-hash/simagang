...
<div class="form-card">
    ...
    <div class="form-card-body">
        ...
        @endif
        <div class="mhs-info">
            <strong>Mahasiswa:</strong> {{ $project->magang?->mahasiswa?->nama_mhs ?? '—' }} &mdash; {{ $project->magang?->lowongan?->nama_low ?? '—' }}
        </div>
        <form action="{{ route('project.update', $project->id) }}" method="POST">
            @csrf @method('PUT')
            <div class="form-group">
                <label class="form-label">Nama Project <span class="req">*</span></label>
                <input type="text" name="nama_project" class="form-control-c" value="{{ old('nama_project', $project->nama_project) }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="teknologi" class="form-control-c" value="{{ old('teknologi', $project->teknologi) }}">
            </div>
            ...
            <div class="form-row-2">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_mulai" class="form-control-c" value="{{ old('tgl_mulai', $project->tgl_mulai?->format('Y-m-d')) }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Tanggal Selesai</label>
                    <input type="date" name="tgl_selesai" class="form-control-c" value="{{ old('tgl_selesai', $project->tgl_selesai?->format('Y-m-d')) }}">
                </div>
            </div>
