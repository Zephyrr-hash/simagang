@extends('layouts.app')
@section('title', 'Kirim Laporan Bimbingan')
@section('breadcrumb')
...
.proj-badge{display:inline-flex;align-items:center;gap:0.4rem;background:#F5F3FF;color:#7C3AED;border-radius:8px;padding:0.4rem 0.875rem;font-size:0.8rem;font-weight:600;margin-bottom:1.25rem;}
</style>
@endpush
@section('content')
<div class="form-card">
    <div class="form-card-header">
        ...
        <p>Kirim laporan progress kepada dosen pembimbing.</p>
    </div>
    <div class="form-card-body">
        ...
        @endif
        <form action="{{ route('project.bimbingan.store', $project->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
