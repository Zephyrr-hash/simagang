...
<style>
    ...
    .form-control-custom { width:100%;padding:.65rem 1rem;border:1.5px solid #E2E8F0;border-radius:9px;font-size:.875rem;color:#0F172A;background:#FAFAFA;outline:none;transition:border-color .2s,box-shadow .2s; }
    ...
    .btn-cancel { background:#fff;color:#6B7280;border:1.5px solid #CBD5E1;border-radius:9px;padding:.65rem 1.25rem;font-weight:600;font-size:.9rem;text-decoration:none; }
...
<div class="form-card">
    <div class="form-card-header">
        <h1>Edit User</h1>
        <p>Mengubah data akun: <strong>{{ $user->name }}</strong></p>
    </div>
