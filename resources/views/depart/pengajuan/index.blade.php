@extends('layouts.app')
@section('title', 'Pengajuan Dospem')
@section('breadcrumb')
<nav aria-label="breadcrumb"><ol class="breadcrumb mb-0">
    <li class="breadcrumb-item"><a href="{{ route('depart.home') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Pengajuan Dospem</li>
</ol></nav>
@endsection
@push('styles')
<style>
...
.btn-assign{display:inline-flex;align-items:center;gap:0.3rem;background:linear-gradient(135deg,#4F46E5,#7C3AED);color:#fff;border-radius:7px;padding:0.35rem 0.85rem;font-size:0.78rem;font-weight:600;text-decoration:none;transition:opacity 0.2s;}
.btn-assign:hover{opacity:0.88;color:#fff;}
...
<div class="page-header">
    ...
    <p>Mahasiswa yang sudah diterima magang namun belum memiliki dosen pembimbing.</p>
</div>
<div class="table-card">
    <div style="overflow-x:auto;">
        <table>
            <thead>
                <tr><th>#</th><th>Nama Mahasiswa</th><th>Lowongan</th><th>Perusahaan</th>
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="{{ Auth::user()->role_id == \App\Models\Role::SUPERADMIN ? 6 : 5 }}"><div class="empty-state"><p>Semua mahasiswa sudah memiliki dosen pembimbing.</p></div></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
