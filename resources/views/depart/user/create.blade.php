...
<style>
    ...
    .form-label {
        ...
        color: #374151; margin-bottom: 0.4rem; letter-spacing: 0.2px;
    }
...
<div class="form-card">
    <div class="form-card-header">
        ...
        <p>Isi form di bawah untuk membuat akun pengguna baru.</p>
    </div>
    <div class="form-card-body">
        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" class="form-control-custom @error('password') is-invalid @enderror"
