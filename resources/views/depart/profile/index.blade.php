...
<div class="profile-card">
    <div class="profile-header">
        @if($profile?->foto_depart && file_exists(public_path('images/'.$profile->foto_depart)))
            <img src="{{ asset('images/'.$profile->foto_depart) }}" alt="Foto" class="profile-avatar">
        @else
    ...
    <div class="profile-body">
        <div class="info-row"><span class="info-label">Nama</span><span class="info-value">{{ $profile?->nama_depart ?? '—' }}</span></div>
