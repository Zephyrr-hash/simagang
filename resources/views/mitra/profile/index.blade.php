...
<div class="profile-card">
    ...
    <div class="profile-body">
        ...
        <div class="info-row"><span class="info-label">Provinsi</span><span class="info-value">{{ $profile?->provinsi?->nama ?? '—' }}</span></div>
        <div class="info-row"><span class="info-label">Kabupaten/Kota</span><span class="info-value">{{ $profile?->kabupaten?->nama ?? '—' }}</span></div>
        <div class="info-row"><span class="info-label">Kecamatan</span><span class="info-value">{{ $profile?->kecamatan?->nama ?? '—' }}</span></div>
        <div class="info-row"><span class="info-label">Kode Pos</span><span class="info-value">{{ $profile?->kode_pos ?? '—' }}</span></div>
        @if($profile)
