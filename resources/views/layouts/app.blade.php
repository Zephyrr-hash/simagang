    ...
    <nav class="sidebar-nav" aria-label="Menu navigasi">
        ...
        @if($roleId === \App\Models\Role::DOSPEM)
            ...
            <a href="{{ route('dospem.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('dospem.index') || request()->routeIs('dospem.bimbingan') ? 'active' : '' }}"
               aria-current="{{ request()->routeIs('dospem.index') ? 'page' : 'false' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 3.741-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
                </svg>
                Bimbingan Mahasiswa
        ...
        @if($roleId === \App\Models\Role::SUPERVISOR)
            ...
            <a href="{{ route('spv.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('spv.index') || request()->routeIs('spv.logbook') ? 'active' : '' }}"
               aria-current="{{ request()->routeIs('spv.index') ? 'page' : 'false' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        @if($roleId === \App\Models\Role::MAHASISWA)
            ...
            <a href="{{ route('bimbingan.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('bimbingan.*') ? 'active' : '' }}"
               aria-current="{{ request()->routeIs('bimbingan.*') ? 'page' : 'false' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <a href="{{ route('logbook.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('logbook.*') ? 'active' : '' }}"
               aria-current="{{ request()->routeIs('logbook.*') ? 'page' : 'false' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                </svg>
                Logbook
